...
CREATE TABLE `users` (id int(10) NOT NULL AUTO_INCREMENT, name varchar(60) NOT NULL, email varchar(60) NOT NULL, age date NOT NULL, role tinyint NOT NULL, PRIMARY KEY (id));
